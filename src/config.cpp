...
lemlib::TrackingWheel vertiTrackingWheel(&vertiRot, lemlib::Omniwheel::NEW_2,-1.5748);

pros::Rotation horRot(HOR_ROT);
lemlib::TrackingWheel horTrackingWheel(&horRot, lemlib::Omniwheel::NEW_2,-1.4567);
